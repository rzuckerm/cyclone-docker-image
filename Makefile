CYCLONE_VERSION := $(shell cat CYCLONE_VERSION)
CYCLONE_DEPS := $(wildcard CYCLONE_*)
DOCKER_TAG_PREFIX := rzuckerm/cyclone:$(CYCLONE_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(CYCLONE_DEPS)
